...
<style>
/* Mise en forme du contenu, dans l'éditeur comme sur la page publique. */
.editeur .prose-editeur,
.contenu-legal {
  padding: 1.25rem;
  min-height: 24rem;
  line-height: 1.7;
...
.contenu-legal { padding: 0; min-height: 0; }

.editeur .prose-editeur h2,
.contenu-legal h2 {
...
.editeur .prose-editeur p,
.contenu-legal p { margin: 0 0 1rem; max-width: 70ch; }

.editeur .prose-editeur ul,
.contenu-legal ul { list-style: disc; padding-left: 1.5rem; margin: 0 0 1rem; }

.editeur .prose-editeur ol,
.contenu-legal ol { list-style: decimal; padding-left: 1.5rem; margin: 0 0 1rem; }

.editeur .prose-editeur li,
.contenu-legal li { margin-bottom: 0.35rem; }

.editeur .prose-editeur blockquote,
...
.editeur .prose-editeur blockquote p:last-child,
.contenu-legal blockquote p:last-child { margin-bottom: 0; }

.editeur .prose-editeur a,
.contenu-legal a { color: #c2410c; text-decoration: underline; }

.editeur .prose-editeur img,
.contenu-legal img { max-width: 100%; height: auto; border-radius: 0.75rem; margin: 0 0 1rem; }

.editeur .prose-editeur iframe,
.contenu-legal iframe { max-width: 100%; border-radius: 0.75rem; border: 0; margin: 0 0 1rem; }

.editeur .prose-editeur hr,
.contenu-legal hr { border: 0; border-top: 1px solid #e5ddd7; margin: 2rem 0; }
</style>
