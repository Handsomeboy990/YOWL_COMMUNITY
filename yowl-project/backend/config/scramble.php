...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'REST API for the YOWL Community platform. Community reviews, threaded comments, reactions, tags, KPI metrics and administration endpoints. Authentication relies on Laravel Sanctum bearer tokens obtained through the login endpoint.',
    ],
